...
public:
    ...
    static QImage resizeLanczos4Region(const QImage& source, QSize fullDestinationSize,
...
private:
    ...
    static QVector<Contribution> buildContributions(int sourceLength, int destinationLength,
                                                    int firstDestination, int count);
