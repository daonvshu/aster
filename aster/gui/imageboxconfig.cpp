...
const ImageBoxConfig::LoadingErrorWidgetFactory& ImageBoxConfig::loadingErrorWidgetFactory() const {
    static const LoadingErrorWidgetFactory empty;
    return loadingErrorWidgetFactory_ ? *loadingErrorWidgetFactory_ : empty;
}

ImageBoxConfig& ImageBoxConfig::loadingErrorWidget(LoadingErrorWidgetFactory factory) {
    loadingErrorWidgetFactory_ = factory ? QSharedPointer<LoadingErrorWidgetFactory>::create(std::move(factory)) : QSharedPointer<LoadingErrorWidgetFactory>{};
    return *this;
}
